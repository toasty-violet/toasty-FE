...
export function LiveHeader({
  ...
  return (
    <header className="flex w-full items-center gap-12 bg-gradient-to-b from-[#1a1c204d] from-20% to-transparent px-20 pt-[calc(1.2rem+env(safe-area-inset-top))] pb-24">
